        ...
        <div className="container">
          <div className="contact-grid">
            ...
            <div className="contact-info-side">
              ...
              <div className="cis-card reveal"><div className="cis-header"><div className="cis-icon">✉️</div><h3>Email Us</h3></div><p><a href="mailto:info@surevriksha.com">info@surevriksha.com</a></p></div>
